    ...
    <div className='w-[428px] md:w-[1280px] md:h-[1049px] '>
        ...
        <div className=' md:grid grid-cols-[repeat(3,_1fr)] pt-12 md:pt-0 md:gap-y-16'>
          ...
          <section className='w-[380px] md:w-[410.67px] h-[132px] bg-[#F7F7F7] m-6 md:m-0 flex justify-start items-center rounded-md'>
            <span className='w-[100px] h-[100px] bg-white flex justify-center items-center rounded-[4px] ml-3'> <Image src={'/Boxes/pen-tool-2.png'} alt='' width={32} height={32} /> </span>
          ...
          {/* Box 2 */}
          <section className='w-[380px] md:w-[410.67px] h-[132px] bg-[#F7F7F7] m-6 md:m-0 flex justify-start items-center rounded-md'>
            <span className='w-[100px] h-[100px] bg-white flex justify-center items-center rounded-[4px] ml-3'> <Image src={'/Boxes/volume-high.png'} alt='' width={32} height={32} /> </span>
          ...
          {/* Box 3 */}
          <section className='w-[380px] md:w-[410.67px] h-[132px] bg-[#F7F7F7] m-6 md:m-0 flex justify-start items-center rounded-md'>
            <span className='w-[100px] h-[100px] bg-white flex justify-center items-center rounded-[4px] ml-3'> <Image src={'/Boxes/group.png'} alt='' width={32} height={32} /> </span>
          ...
          <section className='hidden w-[410.67px] h-[132px] bg-[#F7F7F7] md:flex justify-start items-center rounded-md'>
            <span className='w-[100px] h-[100px] bg-white flex justify-center items-center rounded-[4px] ml-3'> <Image src={'/Boxes/microphone.png'} alt='' width={32} height={32} /> </span>
          ...
          {/* Box 5 */}
          <section className='hidden w-[410.67px] h-[132px] bg-[#F7F7F7] md:flex justify-start items-center rounded-md'>
            <span className='w-[100px] h-[100px] bg-white flex justify-center items-center rounded-[4px] ml-3'> <Image src={'/Boxes/link.png'} alt='' width={32} height={32} /> </span>
          ...
          {/* Box 6 */}
          <section className='hidden w-[410.67px] h-[132px] bg-[#F7F7F7] md:flex justify-start items-center rounded-md'>
            <span className='w-[100px] h-[100px] bg-white flex justify-center items-center rounded-[4px] ml-3'> <Image src={'/Boxes/arrow-2.png'} alt='' width={32} height={32} /> </span>
          ...
          {/* Box 7 */}
          <section className='hidden w-[410.67px] h-[132px] bg-[#F7F7F7] md:flex justify-start items-center rounded-md'>
            <span className='w-[100px] h-[100px] bg-white flex justify-center items-center rounded-[4px] ml-3'> <Image src={'/Boxes/briefcase.png'} alt='' width={32} height={32} /> </span>
          ...
          {/* Box 8 */}
          <section className='hidden w-[410.67px] h-[132px] bg-[#F7F7F7] md:flex justify-start items-center rounded-md'>
            <span className='w-[100px] h-[100px] bg-white flex justify-center items-center rounded-[4px] ml-3'> <Image src={'/Boxes/Book.png'} alt='' width={32} height={32} /> </span>
          ...
          {/* Box 9 */}
          <section className='hidden w-[410.67px] h-[132px] bg-[#F7F7F7] md:flex justify-start items-center rounded-md'>
            <span className='w-[100px] h-[100px] bg-white flex justify-center items-center rounded-[4px] ml-3'> <Image src={'/Boxes/Book2.png'} alt='' width={32} height={32} /> </span>
