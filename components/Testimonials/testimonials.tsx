        ...
        <div className='w-[428px] md:w-[1280px] h-[830.89px] bg-[#F7F7F7]'>
            ...
            <div className='w-[428px] md:w-[1152px] h-[321.89px] md:ml-[64px] md:mt-[80px] md:flex justify-between items-center'>
                ...
                <section className='w-[362.67px] h-full m-8 border-[1px] border-black p-8 '>
                    <Image src={'/Images/5Stars.svg'} alt='Rating' width={116} height={18.89} />
                    ...
                    <span className='flex'>
                        <Image className='rounded-full' src={'/Images/Image9.svg'} alt='Image' width={56} height={56} />
                ...
                <section className='hidden md:block w-[362.67px] h-full border-[1px] border-black p-8'>
                    ...
                    <span className='flex'>
                        <Image className='rounded-full' src={'/Images/Image7.svg'} alt='Image' width={56} height={56} />
                ...
                <section className='hidden md:block w-[362.67px] h-full border-[1px] border-black p-8'>
                    ...
                    <span className='flex'>
                        <Image className='rounded-full' src={'/Images/Image12.svg'} alt='Image' width={56} height={56} />
            ...
            <div className='w-[428px] md:w-[1215px] flex justify-between items-center'>
                <Image className='m-16' src={'/Images/Slider Dots.svg'} alt='Slider DOts' width={72} height={8} />
                <span className='w-[111px] h-[48px] gap-2 flex justify-between'>
                    <button className='border-[1px] border-black rounded-full p-3 gap-4'> <Image src={'/Images/Vector.svg'} alt='Slider' width={16} height={16} /> </button>
                    <button className='border-[1px] border-black rounded-full p-3'> <Image src={'/Images/Vector2.svg'} alt='Slider' width={16} height={16} /> </button>
                </span>
            </div>
